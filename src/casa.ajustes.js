...
export const ajustes = {
  ...
  mobiliario: [
    ...
    { tipo: 'carro', pos: [2.05, -1.4], rot: 180, pav: 'subsolo', cor: 'carro_preto' },
    { tipo: 'carro', pos: [4.1, -1.2], rot: 180, pav: 'subsolo', cor: 'carro_vermelho', modelo: 'picape' },
    ...
    { tipo: 'balcao_bar', pos: [6.6, 5.65], rot: 90, pav: 'subsolo', largura: 1.6, semPrateleiras: true },
    { tipo: 'banqueta', pos: [6.55, 2.4], pav: 'subsolo' },
    { tipo: 'banqueta', pos: [6.55, 3.05], pav: 'subsolo' },
    { tipo: 'banqueta', pos: [6.55, 3.7], pav: 'subsolo' },
    { tipo: 'banqueta', pos: [6.55, 4.35], pav: 'subsolo' },
    { tipo: 'geladeira', pos: [7.3, 1.5], rot: -90, pav: 'subsolo' },
    { tipo: 'adega', pos: [5.75, 6.93], rot: 0, pav: 'subsolo', largura: 1.6, altura: 2.2 },
    { tipo: 'pendente', pos: [6.6, 3.0], pav: 'subsolo', z: 2.0, corrente: 0.35, estilo: 'gaiola' },
    { tipo: 'pendente', pos: [6.6, 4.4], pav: 'subsolo', z: 2.0, corrente: 0.35, estilo: 'gaiola' },
