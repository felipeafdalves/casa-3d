...
export class Iluminacao {
  constructor(scene, renderer, luzes) {
    ...
    this.hemi = new THREE.HemisphereLight('#cfe3ff', '#6b6152', 0.6);
    scene.add(this.hemi);
  ...
  aplicarHDR() {
    ...
    this.scene.environmentIntensity = this.noite ? 0.25 : 0.9;
  ...
  definirHora(h) {
    ...
    this.renderer.toneMappingExposure = noite ? 0.8 : 1.0;
