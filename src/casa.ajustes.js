...
export const ajustes = {
  ...
  mobiliario: [
    ...
    // bar no nicho nordeste, encostado à parede norte, bancos virados para norte; adega na parede leste
    { tipo: 'balcao_bar', pos: [6.3, 6.6], rot: 0, pav: 'subsolo', largura: 2.6 },
    { tipo: 'banqueta', pos: [5.35, 5.8], pav: 'subsolo' },
    { tipo: 'banqueta', pos: [5.98, 5.8], pav: 'subsolo' },
    { tipo: 'banqueta', pos: [6.62, 5.8], pav: 'subsolo' },
    { tipo: 'banqueta', pos: [7.25, 5.8], pav: 'subsolo' },
    { tipo: 'adega', pos: [7.5, 3.8], rot: -90, pav: 'subsolo', largura: 2.4, altura: 2.2 },
    { tipo: 'pendente', pos: [5.7, 6.2], pav: 'subsolo', z: 2.0, corrente: 0.35, estilo: 'gaiola' },
    { tipo: 'pendente', pos: [6.9, 6.2], pav: 'subsolo', z: 2.0, corrente: 0.35, estilo: 'gaiola' },
