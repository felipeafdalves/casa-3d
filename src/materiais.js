...
const receitas = {
  ...
  nogueira_escura: () => padrao(madeira({ seed: 43, tabuas: 4, claridade: 1.15 }), { rep: [1, 1], rough: 0.35, normal: 0.3, cor: '#8a6a50' }), // mesa de jantar (tingimento escuro)
  linho_claro: () => padrao(tecido({ cor: [168, 155, 138], seed: 17 }), { rep: [5, 5], rough: 1 }),
  linho_taupe: () => padrao(tecido({ cor: [152, 140, 124], seed: 15 }), { rep: [5, 5], rough: 1 }),
