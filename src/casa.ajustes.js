...
export const ajustes = {
  ...
  pisos: {
    ...
    terreo: {
      ...
      poligono: [[0.35, -2.75], [9.09, -2.75], [9.09, 15.5], [0, 15.5], [0, 8.725], [0.35, 8.725]],
      // sem laje aqui (a escada para o subsolo e o poço)
      furos: [
        [[0.44, 4.24], [1.54, 4.24], [1.54, 7.14], [0.44, 7.14]],
        [[1.54, 6.04], [3.92, 6.04], [3.92, 7.14], [1.54, 7.14]],
      ],
      exteriores: [
    ...
    superior: {
      ...
      furos: [[[0.64, 6.04], [4.2, 6.04], [4.2, 8.64], [0.64, 8.64]]],
      exteriores: [
  ...
  vazios: {
    terreo: [[[5.59, 2.855], [8.49, 2.855], [8.49, 15.405], [5.59, 15.405]]],
    subsolo: [
      [[0.44, 4.24], [1.54, 4.24], [1.54, 7.14], [0.44, 7.14]],
      [[1.54, 6.04], [3.92, 6.04], [3.92, 7.14], [1.54, 7.14]],
    ],
  ...
  alturasParede: { subsolo: [{ perto: [3.12, 6.58], topo: 0.85 }] },
  ...
  vaosRemover: { terreo: [[9.09, 7.8], [4.0, 6.36]], superior: [[4.0, 2.12], [5.48, 0.62]] },
  vaosExtra: {
  ...
  vidrosIgnorar: {
    terreo: [[0.53, 8.0], [0.58, 8.0], [5.5, -2.1], [5.5, 0.44], [8.58, 1.9], [8.6, 1.9], [6.4, 15.47], [7.0, 15.5], [7.3, -3.2], [7.3, -3.17], [2.36, 8.54], [2.36, 8.59]],
  ...
  escadas: [
    {
      id: 'terreo-superior',
      lances: [
        { de: [4.18, 8.0], para: [1.73, 8.0], largura: 1.2, z0: 1.5, z1: 2.9, degraus: 8 },
        { patamar: [[0.64, 6.14], [1.73, 8.64]], z: 2.9 },
        { de: [1.73, 6.69], para: [4.43, 6.69], largura: 1.1, z0: 2.9, z1: 4.47, degraus: 9 },
      ],
      guardas: [
        { a: [1.73, 7.39], b: [4.2, 7.39], altura: 1.1, z: 'rampa' },
        { a: [4.15, 7.44], b: [4.15, 8.64], altura: 1.1, z: 4.47 },
      ],
    },
    {
      id: 'terreo-subsolo',
      lances: [
        { de: [3.92, 6.59], para: [1.54, 6.59], largura: 1.05, z0: 1.5, z1: 0.225, degraus: 7 },
        { patamar: [[0.44, 6.04], [1.54, 7.14]], z: 0.225 },
        { de: [0.99, 6.04], para: [0.99, 4.24], largura: 1.05, z0: 0.225, z1: -1.05, degraus: 7 },
      ],
      guardas: [{ a: [1.54, 4.24], b: [1.54, 6.04], altura: 1.1, z: 1.5 }],
    },
  ],
  ...
  ambientes: {
    terreo: {
      ...
      'Brinquedoteca': { piso: 'madeira_escura', parede: 'parede_creme', lambri: true, lambriMaterial: 'shiplap_branco', lambriTipo: 'ripado', poligono: [[5.565, -2.665], [9.005, -2.665], [9.005, 0.99], [5.565, 0.99]] },
  ...
  mobiliario: [
    ...
    { tipo: 'lareira', pos: [8.8, 7.8], rot: -90, pav: 'terreo', altura: 5.6, largura: 1.9 },
    ...
    { tipo: 'estante_arcos', pos: [7.29, 3.08], rot: 180, pav: 'terreo', largura: 3.3, altura: 2.7 },
    ...
    // ---- Varandas
    { tipo: 'poltrona', pos: [7.0, -3.6], rot: 180, pav: 'terreo', z: -0.05, material: 'ratan' },
    { tipo: 'poltrona', pos: [8.3, -3.6], rot: 180, pav: 'terreo', z: -0.05, material: 'ratan' },
    { tipo: 'mesa_lateral', pos: [7.65, -3.9], pav: 'terreo', z: -0.05 },
    ...
    { tipo: 'mesa_console', pos: [4.33, 6.2], rot: 90, pav: 'superior', largura: 1.2 },
