...
- **Escadas pelas linhas do DWG**: a escada da sala (8 + 8 espelhos, patamar a oeste) e a da garagem (6 + 7, descendo
  ao longo da parede oeste) seguem os degraus desenhados na camada de mobiliário do DWG; guardas de balaústres pretos
  com corrimão de madeira em cada lance, mureta entre a subida e o poço da descida, corrimãos metálicos na escada de entrada.
- **Bay window da brinquedoteca** (paredes oblíquas do DWG) com banco almofadado, e divisória de vidro com caixilho
  preto e porta para o hall.
- **Cor calibrada**: tone mapping AgX, brancos com albedo realista (paredes, marcenaria, teto, siding), pedra
  "ledgestone" à escala real na lareira.
...
tira capturas de 24 pontos da casa, gera **plantas de topo de cada pavimento** (para auditar as divisões contra o DWG
e o PDF) e corre testes de movimento: subir os dois lances da escada até ao piso superior, bater na parede do hall, ser
bloqueado pela porta fechada e passar com ela aberta, descer os dois lances até à garagem. No fim corre uma **auditoria do mobiliário**: cada peça é
