...
export const ajustes = {
  ...
  paredesExtra: {
    // garagem: parede que fecha o espaço debaixo do 1.º lance da escada, entre a escada e o lavabo (parede da TV)
    subsolo: [{ a: [1.54, 5.75], b: [3.21, 5.75], esp: 0.15 }],
    terreo: [
  ...
  mobiliario: [
    ...
    { tipo: 'glb', url: './modelos/SheenChair.glb', pos: [6.9, 5.25], rot: 20, pav: 'terreo', largura: 0.82 },
    { tipo: 'glb', url: './modelos/SheenChair.glb', pos: [8.0, 5.25], rot: -20, pav: 'terreo', largura: 0.82 },
    ...
    { tipo: 'glb', url: './modelos/GlamVelvetSofa.glb', pos: [4.85, -1.6], rot: -90, pav: 'superior', largura: 1.9, tinta: '#2e5238' },
    ...
    // ---- Subsolo (planta "Garagem" do projeto de interiores): dois carros de frente para o interior junto ao portão;
    // lounge ao centro (chesterfield virado a norte para a TV na parede da escada/lavabo, tapete e mesa de centro);
    // bar corrido na parede leste com quatro bancos e frigobar na ponta; adega na parede norte; armário junto ao portão
    { tipo: 'carro', pos: [2.0, -1.5], rot: 180, pav: 'subsolo', cor: 'carro_preto', modelo: 'sedan' }, // Jetta preto
    { tipo: 'carro', pos: [4.05, -1.3], rot: 180, pav: 'subsolo', cor: 'carro_vermelho', modelo: 'picape' }, // C10 vermelha
    { tipo: 'spots_teto', pos: [3.0, -1.2], pav: 'subsolo', z: 2.372, colunas: 2, linhas: 2, passoX: 2.0, passoY: 2.6 },
    { tipo: 'spots_teto', pos: [6.8, 1.5], pav: 'subsolo', z: 2.372, colunas: 1, linhas: 3, passoY: 2.0 },
    { tipo: 'portao_garagem', pos: [2.565, -4.36], rot: 0, pav: 'subsolo', largura: 4.0, altura: 2.3 },
    { tipo: 'guarda_roupa', pos: [6.15, -4.02], rot: 180, pav: 'subsolo', largura: 1.2, material: 'marcenaria_cinza' },
    { tipo: 'glb', url: './modelos/SheenWoodLeatherSofa.glb', pos: [3.25, 2.5], rot: 180, pav: 'subsolo', largura: 2.6 },
    { tipo: 'tapete', pos: [3.25, 4.0], rot: 0, pav: 'subsolo', dims: [3.2, 2.4], material: 'boucle' },
    { tipo: 'mesa_live_edge', pos: [3.25, 4.05], rot: 0, pav: 'subsolo', largura: 1.4, prof: 0.6 },
    { tipo: 'painel_tv', pos: [3.2, 5.45], rot: 0, pav: 'subsolo', material: 'nogueira', largura: 2.8 },
    { tipo: 'pendente', pos: [2.4, 4.0], pav: 'subsolo', z: 2.05, corrente: 0.3, estilo: 'gaiola' },
    { tipo: 'pendente', pos: [4.1, 4.0], pav: 'subsolo', z: 2.05, corrente: 0.3, estilo: 'gaiola' },
    { tipo: 'galeria', pos: [0.53, 3.4], rot: 90, pav: 'subsolo', z: 1.5, colunas: 2, linhas: 1, largura: 0.6, altura: 0.8 },
    { tipo: 'arandela', pos: [0.53, 2.5], rot: 90, pav: 'subsolo', z: 1.6 },
    { tipo: 'arandela', pos: [0.53, 4.3], rot: 90, pav: 'subsolo', z: 1.6 },
    { tipo: 'vaso_planta', pos: [4.9, 5.2], pav: 'subsolo', variante: 'arbusto' },
    // bar corrido na parede leste (prateleiras de garrafas atrás); a bancada dos bancos sai dele em península,
    // perpendicular à parede, com os quatro bancos do lado sul virados para norte; adega na parede norte
    { tipo: 'balcao_bar', pos: [7.3, 4.5], rot: -90, pav: 'subsolo', largura: 5.0 },
    // península curta (1,3 m, dois bancos) na ponta sul do bar, perpendicular à parede leste
    { tipo: 'balcao_bar', pos: [6.3, 2.35], rot: 0, pav: 'subsolo', largura: 1.3, semPrateleiras: true },
    { tipo: 'banqueta', pos: [5.97, 1.6], pav: 'subsolo' },
    { tipo: 'banqueta', pos: [6.63, 1.6], pav: 'subsolo' },
    { tipo: 'adega', pos: [5.75, 6.93], rot: 0, pav: 'subsolo', largura: 1.6, altura: 2.2 },
    { tipo: 'pendente', pos: [6.3, 2.35], pav: 'subsolo', z: 2.0, corrente: 0.35, estilo: 'gaiola' },
    { tipo: 'pendente', pos: [6.9, 5.2], pav: 'subsolo', z: 2.0, corrente: 0.35, estilo: 'gaiola' },
  ...
  luzes: [
    ...
    { pos: [3.0, -1.2], pav: 'subsolo', z: 1.9, int: 3 },
    { pos: [3.2, 3.2], pav: 'subsolo', z: 1.9, int: 3 },
