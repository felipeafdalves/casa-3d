...
function reboco({ cor = [244, 241, 234], tam = 512, seed = 5, granulo = 10 } = {}) {
  const c = canvas(tam);
  const ctx = c.getContext('2d');
  const h = canvas(tam);
  const hctx = h.getContext('2d');
...
const receitas = {
  ...
  parede_creme: () => padrao(reboco({ cor: [236, 230, 218] }), { rep: [1, 1], rough: 0.85, normal: 0.25 }),
  ...
  pedra: () => padrao(pedra(), { rep: [1 / 1.6, 1 / 1.6], rough: 0.9, normal: 1.2 }),
  tijolo: () =>
    new THREE.MeshStandardMaterial({
  ...
  siding: () => padrao(ripado({ cor: [226, 224, 218], largura: 0.2, vertical: false }), { rep: [1, 1], rough: 0.8, normal: 0.5 }),
  shiplap_azul: () => padrao(ripado({ cor: [150, 163, 182], largura: 0.12, vertical: true }), { rep: [1, 1], rough: 0.6, normal: 0.6 }),
  shiplap_branco: () => padrao(ripado({ cor: [240, 238, 232], largura: 0.12, vertical: true }), { rep: [1, 1], rough: 0.6, normal: 0.5 }),
  ...
  teto: () => new THREE.MeshStandardMaterial({ color: '#f6f4ef', roughness: 0.95 }),

  // marcenaria / móveis
  marcenaria_branca: () => new THREE.MeshStandardMaterial({ color: '#f1efe9', roughness: 0.45 }),
